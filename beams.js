(function () {
  ...
  function initBeams() {
    ...
    // Inject custom shader helper functions inside vertexShader
    var vertexShader = physical.vertexShader;
    ...
    // Apply distortion in main code, keeping base declarations intact
    vertexShader = vertexShader
      .replace("#include <begin_vertex>", "#include <begin_vertex>\n      transformed.z += getPos(transformed.xyz);")
      .replace("#include <beginnormal_vertex>", "#include <beginnormal_vertex>\n      objectNormal = getNormal(position.xyz);");

    // Inject custom variables in fragmentShader
    var fragmentShader = physical.fragmentShader;
